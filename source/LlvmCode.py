...
#
#
# def convert_operator_stack_to_str(operator_stack: typing.List[TypeModifierNode.TypeModifierNode.TypeModifier]) -> str:
#     """
...
#
#
# def llvm_allocate_instruction(target_register: str, spec_type: TypeModifierNode.TypeModifier, operator_stack,
...
#
#
# def llvm_store_instruction(source_type: TypeModifierNode.TypeModifier, source_register: str,
#                            source_operator_stack: List[TypeModifierNode.TypeModifier],
#                            target_type: TypeModifierNode.TypeModifier, target_register: str,
#                            target_operator_stack: List[TypeModifierNode.TypeModifier],
#                            indent_string: str) -> str:
#     """
#
...
#
#
# def llvm_store_instruction_c(source_type: TypeModifierNode.TypeModifier, source_constant: str,
#                              source_operator_stack: List[TypeModifierNode.TypeModifier],
#                              target_type: TypeModifierNode.TypeModifier, target_register: str,
#                              target_operator_stack: List[TypeModifierNode.TypeModifier],
#                              indent_string: str) -> str:
...
#
#
# def llvm_load_instruction(source_type: TypeModifierNode.TypeModifier, source_register: str,
#                           source_operator_stack: List[TypeModifierNode.TypeModifier],
#                           target_type: TypeModifierNode.TypeModifier, target_register: str,
#                           target_operator_stack: List[TypeModifierNode.TypeModifier],
#                           indent_string: str) -> str:
